...
# Calculate angles for the labels 
...
gr <- ggplot(dt_viz, aes(x = factor(shape, levels = dt_viz$shape), y = count, fill = certainty)) +
    ...
    labs(
        title = "The shape of the unknown",
        subtitle = "Analysis of 80,000+ records shows that our night sky is defined by <span style='color:#e0b1f1'><b>Uncertain Phenomena</b></span>.<br>For every report of a <span style='color:#4a4e69'><b>Concrete Object</b></span>, there are thousands of unidentifiable flashes and lights.",
    ...
    theme(
        ...
        # Typography
        plot.title = element_markdown(size = 15, face = "bold", hjust = 0.5, color = "white", margin = margin(t = 10)),
